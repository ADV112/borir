					...
					<ul class="uk-switcher uk-margin">
						<li>
							<div class="uk-alert-danger" uk-alert>
								<strong>NB:</strong> Pengantaran Hanya Khusus Antar Wilayah Palembang
							</div>
							<div class="uk-grid-small" uk-grid>
						...
						<li>
							<div class="uk-margin-bottom" id="penerima-container">
								<div class="uk-margin">
									<label for="">Alamat Pembelian</label>
									<textarea name="alamat" id="alamat_pembelian" class="uk-textarea" cols="30" rows="5"></textarea>
								</div>
							</div>

							<div id="item-container" uk-grid>
		...
		<div class="uk-width-1-1 uk-width-1-3@m">
			<div class="uk-card uk-card-small uk-card-default">
				<div class="uk-card-body">
					...
					<?= form_open('user/create-payment-jastip', ['id' => 'tagihan-form']) ?>
					...
					<input type="hidden" name="alamat_beli">
					<div class="uk-margin">
	...
	<div class="uk-modal-dialog uk-modal-body">
		...
		<form id="penerima-form">
			...
			<div class="uk-margin">
				...
				<input type="number" name="jumlah_barang" class="uk-input" placeholder="Jumlah Barang">
			</div>
			<div class="uk-margin">
				<label for="">Perkiraan Harga Barang</label>
				<input type="number" name="harga_barang" class="uk-input" placeholder="Perkiraan Harga per Barang">
			</div>
		</form>
