...
$(document).ready(function () {
	...
	var dt = $('table').DataTable({
		...
		'columns': [{
			...
			},
			{
				...
				orderable: false,
				render: function (data, type, full, meta) {
					var btn = '<div class="dropdown"><a href="javascript:;" class="btn px-3 py-2 btn-outline-secondary btn-sm dropdown-toggle opt mb-0" data-bs-toggle="dropdown" id="navbarDropdownMenuLink2"><i class="fa-solid fa-ellipsis-vertical"></i></a><ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2"><li><a class="dropdown-item" target="_blank" href="' + url + '/branch-detail/' + data.branch_code + '"><i class="fas fa-eye"></i> Detail</a></li><li><a class="dropdown-item delete" href="javascript:;"><i class="fa fa-trash"></i> Delete</a></li></ul></div>';
					return btn;
				}
			}
		],
	...
	dt.on('click', '.delete', function () {
		...
		$('#deleteHidden').val(id.branch_code);
